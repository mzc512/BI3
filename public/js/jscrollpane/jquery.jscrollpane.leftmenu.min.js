(function(factory){if(typeof define==='function'&&define.amd){define(['jquery.mousewheel'],factory);}else if(typeof exports==='object'){module.exports=factory(require('jquery'));}else{factory(jQuery);}}(function($){$.fn.jScrollPane=function(settings)
...
(parseInt(elem.css('paddingRight'),10)||0);}
    ...
    {verticalTrack.height(verticalTrackHeight+'px');verticalDragPosition=0;scrollbarWidth=settings.verticalGutter+verticalTrack.outerWidth();pane.width(paneWidth-scrollbarWidth-originalPaddingTotalWidth);try{}catch(err){}}
    ...
    {if(isScrollableH&&isScrollableV){var horizontalTrackHeight=horizontalTrack.outerHeight(),verticalTrackWidth=verticalTrack.outerWidth();$(horizontalBar).find('>.jspCap:visible,>.jspArrow').each(function()
    ...
    {if(destX===undefined){destX=horizontalDrag.position().left;}
        ...
        updateHorizontalArrows(isAtLeft,isAtRight);elem.trigger('jsp-scroll-x',[-destLeft,isAtLeft,isAtRight]).trigger('scroll');}
