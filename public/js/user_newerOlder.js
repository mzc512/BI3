...
function selectedDaily(startDt, endDt) {
    $.ajax({
        type: 'GET',
        url: '/router/rest/method/newOlderProportion/begin/' + startDt + '/end/' + endDt,
...
function selectedWeekly(startDt, endDt) {
    $.get("/router/rest/method/newOlderweek/begin/" + startDt + "/end/" + endDt, function (data, status) {
...
function selectedMonthly(begintimes,endtimes){
    ...
    $.get("/router/rest/method/newOlderMonthly/begintimes/" + begintimes+"/endtimes/"+ endtimes, function (data, status) {
        if (status == "success") {
            var respObj = data;
            if (respObj.result == true) {
                var mthArray = [];
...
function selectedQuarterly(year) {
    $.get("/router/rest/method/newOlderQuarterly/year/" + year, function (data, status) {
        if (status == "success") {
            var respObj = data;
            if (respObj.result == true) {
                var qrtArray = [];
...
function selectedYearly(year) {
    $.get("/router/rest/method/newOlderyears/year/" + year, function (data, status) {
        if (status == "success") {
            var respObj = data;
            if (respObj.result == true) {
                var yearArray = [];
