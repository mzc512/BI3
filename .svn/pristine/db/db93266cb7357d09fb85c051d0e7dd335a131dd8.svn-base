...
$('#toobar').show();
$("#group").append('<li class="active"><a href="#daily" data-toggle="tab">注册会员日报</a></li>');
$("#group").append('<li><a href="#weekly" data-toggle="tab">注册会员周报</a></li>');
$("#group").append('<li><a href="#monthly" data-toggle="tab">注册会员月报</a></li>');
$("#group").append('<li><a href="#quarterly" data-toggle="tab">注册会员季报</a></li>');
$("#group").append('<li><a href="#yearly" data-toggle="tab">注册会员年报</a></li>');
...
function selectedDaily(startDt, endDt) {
    $.ajax({
        type: 'GET',
        url: '/router/rest/method/RegUserDaily/begin/' + startDt + '/end/' + endDt,
...
function selectedWeekly(startDt, endDt) {
    $.get("/router/rest/method/RegUserWeekly/begin/" + startDt + "/end/" + endDt, function (data, status) {
...
function selectedMonthly(begintimes,endtimes) {
    ...
    $.get("/router/rest/method/RegUserMonthly/begintimes/" + begintimes+"/endtimes/"+ endtimes, function (data, status) {
        if (status == "success") {
            var respObj = data;
            if (respObj.result == true) {
                var mthArray = [];
...
function selectedQuarterly(year) {
    $.get("/router/rest/method/RegUserQuarterly/year/" + year, function (data, status) {
        if (status == "success") {
            var respObj = data;
            if (respObj.result == true) {
                var qrtArray = [];
...
function selectedYearly(year) {
    $.get("/router/rest/method/RegUserYearly/year/" + year, function (data, status) {
        if (status == "success") {
            var respObj = data;
            if (respObj.result == true) {
                var yearArray = [];
